...
## 50 local critique loops distilled into v5 requirements

| Loop | Critique pressure | v5 move |
|---:|---|---|
...
| 28 | Could regress to card shell | Static contract asserts v5 markers and banned old selectors absent |
...
| 48 | Need deterministic proof | Smoke stdout `FIFTY_LOOP_DIRECTOR_V5_PASS` |
